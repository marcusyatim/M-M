...
def getTensorTokenizer():
    with open('../../data/transformer/input_tensor.pickle', 'rb') as handle:
        input_tensor = pickle.load(handle)
    with open('../../data/transformer/inp_tokenizer.pickle', 'rb') as handle:
        inp_tokenizer = pickle.load(handle)
    with open('../../data/transformer/target_tensor.pickle', 'rb') as handle:
        target_tensor = pickle.load(handle)
    with open('../../data/transformer/targ_tokenizer.pickle', 'rb') as handle:
...
def getTags(recipe):
    ...
    transformer.load_weights('../../data/transformer/transformer')
